...
class Submitt extends StatefulWidget {
  groups currentgroup;
  String id;
  Submitt(this.currentgroup, this.id);
  _Submmit createState() => _Submmit();
}

class _Submmit extends State<Submitt> {
  ...
  void getAllSubmited() async {
    try {
      ...
      await for (var snapshot in _firestore
          ...
          .where('assigmentid', isEqualTo: widget.id)
          .snapshots()) {
        member.clear();
