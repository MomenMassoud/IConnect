...
class ReplayAudioGroup extends StatefulWidget{
  String urll;String time;String type;String img;String sender;
  ReplayAudioGroup(this.urll,this.time,this.type,this.img,this.sender);
  _ReplayAudioGroup createState()=>_ReplayAudioGroup();
}

class _ReplayAudioGroup extends State<ReplayAudioGroup>{
