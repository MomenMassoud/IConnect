...
import 'Vedio_View_Page_Chat.dart';
...
class CameraScreenChat extends StatefulWidget {
  ChatModel source;
  final ChatModel us;
  CameraScreenChat(this.source, this.us);
  @override
  _CameraScreen createState() => _CameraScreen();
}


class _CameraScreen extends State<CameraScreenChat>{
  late int index;
  int flip=0;
                          ...
                          GestureDetector(
                              ...
                              onLongPressUp: () async {
                                ...
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (builder) => VideoViewPageChat(
                                            videopath.path,
                                            videopath.name,
                                          widget.source,
                                          widget.us
  ...
  void takePhoto(BuildContext context)async{
    try {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => CameraViewChat(paths,id,widget.source,widget.us),
        ),
      );
    } catch (e) {
      print(e);
