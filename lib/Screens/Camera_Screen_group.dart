...
import 'package:chatapp/Screens/Camre_view_group.dart';
import 'package:chatapp/Screens/Vedio_View_Page_Chat.dart';
import 'package:chatapp/Screens/Video_View_Page_group.dart';
...
import 'Camera_View_Chat.dart';
List<CameraDescription> cameras=[];
class CameraScreenGroup extends StatefulWidget{
  final ChatModel source;
  final groups us;
  CameraScreenGroup(this.source,this.us);
  @override
  _CameraScreen createState()=>_CameraScreen();

}

class _CameraScreen extends State<CameraScreenGroup>{
  late int index;
  int flip=0;
                          ...
                          GestureDetector(
                              ...
                              onLongPressUp: () async {
                                ...
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (builder) => VideoViewPageGroup(
                                            videopath.path,
                                            videopath.name,
                                            widget.source,
                                            widget.us
  ...
  void takePhoto(BuildContext context)async{
    try {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => CameraViewgroup(paths,id,widget.source,widget.us),
        ),
      );
    } catch (e) {
      print(e);
