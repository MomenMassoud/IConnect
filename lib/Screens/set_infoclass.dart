...
class SetClassInfo extends StatefulWidget{
  List<ChatModel> member;
  ChatModel currentUser;
  SetClassInfo(this.member,this.currentUser);
  @override
  _SetGroupInfo createState()=>_SetGroupInfo();

}

class _SetGroupInfo extends State<SetClassInfo>{
  late String name;
  late String infor;
  @override
              ...
              await _firestore.collection('Notifications').doc(idd).set(
                  {
                    ...
                    'msg':"Contact  $nn Create Class ($name) And Add you!",
                    'type':"msg",
