...
class ViewMediaOnetoOneChat extends StatefulWidget {
  String type;
  String idGroup;
  ViewMediaOnetoOneChat(this.type, this.idGroup);
  _ViewMediaScreenChat createState() => _ViewMediaScreenChat();
}

class _ViewMediaScreenChat extends State<ViewMediaOnetoOneChat> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
          stream: _firestore.collection('chat').where('chatroom', isEqualTo: widget.idGroup).where('type', isEqualTo: widget.type).snapshots(),
